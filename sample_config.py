...
class Config:
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Scrappyrobot")
    # these platform informations were obtained
    # on 26.06.2021 12:00:00 IST
    APP_PLATFORM = [
        "android",
        "ios",
        "wp",
    ...
    # please reopen
    # https://t.me/kashdayash
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/@Scrappyrobot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @KashdaYash")
